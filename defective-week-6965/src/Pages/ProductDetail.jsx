...
const ProductDetail = () => {
  ...
  const { image, title, productprice, regularprice, discountdetails } =
    productDetail;
    ...
    <div>
      ...
      >
        <Box w="40%" h="400px">
          ...
          >
            <BsHeart size="20px" mt="10px" position="absolute" />
          </Box>
        ...
        >
          ...
          >
            <Box>
              ...
              <Text fontFamily=" Montserrat Regular !important">
                Return Window
              </Text>
            ...
            <Box>
              <Text
                ...
                color="rgb(144,39,53)"
              >
                <RxDoubleArrowDown size="15px" mt="10px" />
                More
              </Text>
              <Text fontFamily=" Montserrat Regular !important">
                Time to Ship
